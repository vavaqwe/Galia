...
responses = {
    "привет": ("Привет! Чем я могу помочь?","здесь можешь кеатива дать "),
    "как дела": ("У меня всё отлично, спасибо!","здесь можешь кеатива дать "),
    "погода": ("Извините, я пока не умею предоставлять информацию о погоде.","здесь можешь кеатива дать ")
